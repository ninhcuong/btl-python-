...
class Tile(pygame.sprite.Sprite):
	...
	def setAttributes(self):
		...
		self.image = pygame.image.load("C:\\Users\\light\\OneDrive\\Documents\\btlpython\\bomberman-pygame-master\\bomberman-pygame-master\\resources\\images\\tiles\\" + str(self.type) + ".png").convert()
