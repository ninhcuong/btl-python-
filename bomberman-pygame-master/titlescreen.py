...
class Titlescreen():
	...
	def __init__(self):
		...
		while not exitMain:
			...
			image_Path = r"C:\\Users\\light\\OneDrive\\Documents\\btlpython\\bomberman-pygame-master\\bomberman-pygame-master\\dist\\bomerman.app\\Contents\\Resources\\resources\\images\\titlescreen.png"
			img = pygame.image.load(image_Path).convert()
			self.screen.blit(img,(0,0))

			pygame.mixer.music.load(r"C:\\Users\\light\\OneDrive\\Documents\\btlpython\\bomberman-pygame-master\\bomberman-pygame-master\\dist\\bomerman.app\\Contents\\Resources\\resources\\sounds\\title.mid")
